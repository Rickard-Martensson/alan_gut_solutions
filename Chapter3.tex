...
\begin{enumerate}
 ...
 \item
    ...
    \[
        E\left[e^{M(t-1)}\right] \sim \psi_{M}(t-1) = \psi_{\Gamma(p,a)}(t-1) = \frac{1}{(1-at)^p} = \frac{\dfrac{1}{1+a}}{1-\dfrac{a}{a+1}(e^t-1)} \sim Ge(\dfrac{1}{1+a})
    \]

    \[
X \sim \text{NegBin}\left(p, \frac{a}{a+1}\right)
\]
\end{enumerate}
